package mvp.circledemo.widgets;
...
import mvp.circledemo.spannable.CircleMovementMethod;
import mvp.circledemo.spannable.SpannableClickable;
...
public class PraiseListView extends TextView{
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(AppContext.getContext(), R.drawable.icon_praise, DynamicDrawableSpan.ALIGN_BASELINE),
