package mvp.circledemo.spannable;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = AppContext.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = AppContext.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
