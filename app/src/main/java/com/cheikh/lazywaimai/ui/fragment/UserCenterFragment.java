...
public class UserCenterFragment extends BaseFragment<UserController.UserUiCallbacks> //继承，实现接口UserUiCallbacks
        implements UserController.UserCenterUi { //实现接口，显示个人信息
